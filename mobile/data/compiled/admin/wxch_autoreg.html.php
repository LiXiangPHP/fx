...
<title><?php echo $this->_var['wxch_lang']['cp_home']; ?> - 自动注册 </title>
...
<h1>
<span class="action-span1"><a href="index.php?act=main"><?php echo $this->_var['wxch_lang']['cp_home']; ?></a> </span><span id="search_id" class="action-span1"> - 自动注册 </span>
