...
E_D("replace into `ecs_shop_config` values('101','1','shop_name','text','','','ECSHOP米奇网-锦尚中国','1');");
E_D("replace into `ecs_shop_config` values('102','1','shop_title','text','','','ECSHOP米奇网-锦尚中国','1');");
E_D("replace into `ecs_shop_config` values('103','1','shop_desc','text','','','ECSHOP米奇网-锦尚中国','1');");
E_D("replace into `ecs_shop_config` values('104','1','shop_keywords','text','','','ECSHOP米奇网-锦尚中国','1');");
...
E_D("replace into `ecs_shop_config` values('108','1','shop_address','text','','','ECSHOP米奇网-锦尚中国','1');");
E_D("replace into `ecs_shop_config` values('109','1','qq','text','','','278869155','1');");
...
E_D("replace into `ecs_shop_config` values('910','8','sms_signin','select','1,0','','0','1');");
E_D("replace into `ecs_shop_config` values('909','8','sms_ecmoban_password','password','','','','0');");
E_D("replace into `ecs_shop_config` values('908','8','sms_ecmoban_user','text','','','','0');");
