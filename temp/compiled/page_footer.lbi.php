...
<div id="bottomNav2" class="box block">
  ...
  <div class="bNavList clearfix">
   ...
   <?php $_from = $this->_var['navigator_list']['bottom']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'nav_0_56600000_1476770610');$this->_foreach['nav_bottom_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['nav_bottom_list']['total'] > 0):
    foreach ($_from AS $this->_var['nav_0_56600000_1476770610']):
        $this->_foreach['nav_bottom_list']['iteration']++;
?>
        <a href="<?php echo $this->_var['nav_0_56600000_1476770610']['url']; ?>" <?php if ($this->_var['nav_0_56600000_1476770610']['opennew'] == 1): ?> target="_blank" <?php endif; ?>><?php echo $this->_var['nav_0_56600000_1476770610']['name']; ?></a>
...
?><br />
    ...
    <?php endif; ?>
       <div align="center" style="padding-bottom:15px;" ><a href="http://www.wanpin123.com" target="_blank"><img src="themes/suning/images/ecmoban.gif" alt="万品网" /></a><br />技术支持:<a href="http://www.wanpin123.com" target="_blank">万品网</a></div>
   ...
   <a target="_blank" href="#" title="可信网站示范单位"><img src="themes/suning/images/bt3.png"></a>
   <a  href="#" title="诚信网站" target="_blank"><img src="themes/suning/images/bt4.png"></a>
   <a  href="#" title="电子营业执照" target="_blank"><img src="themes/suning/images/bt5.png"></a>
        </div>
      <div class="blank"></div> 
 </div>
</div>
