...
<div id="bottomNav2" class="box block">
  ...
  <div class="bNavList clearfix">
   ...
   <?php $_from = $this->_var['navigator_list']['bottom']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'nav_0_80260000_1473753474');$this->_foreach['nav_bottom_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['nav_bottom_list']['total'] > 0):
    foreach ($_from AS $this->_var['nav_0_80260000_1473753474']):
        $this->_foreach['nav_bottom_list']['iteration']++;
?>
        <a href="<?php echo $this->_var['nav_0_80260000_1473753474']['url']; ?>" <?php if ($this->_var['nav_0_80260000_1473753474']['opennew'] == 1): ?> target="_blank" <?php endif; ?>><?php echo $this->_var['nav_0_80260000_1473753474']['name']; ?></a>
