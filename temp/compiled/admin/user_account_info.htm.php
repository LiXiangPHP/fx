...
<div class="main-div">
  <form action="user_account.php" method="post" name="theForm" onsubmit="return validate()">
    <table width="100%">
      ...
      <input type="hidden" name="payment" value='银行汇款/转帐'>
      <input type="hidden" name="usertype" value='<?php echo $this->_var['usertype']; ?>'>
     ...
     <!--  <tr>
        ...
        <td >
          ...
          <option value="银行汇款/转帐"><?php echo $this->_var['lang']['please_select']; ?></option>
