...
<div class="form-div">
  <form action="javascript:searchUser()" name="searchForm">
   ...
   手机号 <input type="text" name="keyword" size="10" />
   <?php if (! $this->_var['process_type']): ?>
      ...
      <?php else: ?>
      <input type="hidden" value="2" name="process_type">
      <input type="hidden" value="<?php echo $this->_var['usertype']; ?>" name="usertype">
      <?php endif; ?>
<!--       <select name="payment">
...
<table cellpadding="3" cellspacing="1">
  <tr>
    <th><a href="javascript:listTable.sort('user_name', 'DESC'); ">手机号</a><?php echo $this->_var['sort_user_name']; ?></th>
    <?php if ($this->_var['usertype'] == 1): ?>
    <th>商户名</th>
    <?php endif; ?>
    ...
    <th><a href="javascript:listTable.sort('payment', 'DESC'); ">户名</a><?php echo $this->_var['sort_payment']; ?></th>
    <th>银行</th>
    <th>账号</th>
...
?>
  <tr>
    ...
    <?php if ($this->_var['usertype'] == 1): ?>
    <td><?php echo $this->_var['item']['Field_zzs']; ?></td>
    <?php endif; ?>
    ...
    <td><?php echo $this->_var['item']['htsort']; ?></td>
    <td><?php echo $this->_var['item']['num']; ?></td>
...
function searchUser()
{
    ...
    listTable.filter['usertype'] = document.forms['searchForm'].elements['usertype'].value;
